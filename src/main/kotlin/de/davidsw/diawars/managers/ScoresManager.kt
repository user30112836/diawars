...
class ScoresManager(private val plugin: Diawars) {
    fun handleInfo(sender: Player) {
        ...
        val teamVaultDiamonds = plugin.store.vaultDiamondStore.getTeamTotal(team)
        ...
        val opponentsVaultDiamonds = plugin.store.vaultDiamondStore.getTeamTotal(opponents)
